...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-20037508.342789, -14448662.855285, 20037508.342789, 42561515.317064], maxZoom: 28, minZoom: 3
    })
});
...
map.getView().fit([-20037508.342789, -14448662.855285, 20037508.342789, 42561515.317064], map.getSize());
